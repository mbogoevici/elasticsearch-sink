...
public class TestTransportMode {
    ...
    public void testSinkPassthrough() throws Exception {
        ...
        Mockito.verify(client, Mockito.times(1)).index((IndexRequest) Mockito.argThat(new ReflectionEquals(MockUtils.getIndexRequestWithoutId())));
    }
