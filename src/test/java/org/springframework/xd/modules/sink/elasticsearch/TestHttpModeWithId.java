...
@ContextConfiguration(locations={"classpath:config/elasticsearch.xml","classpath:elasticsearch/sink/test-http-with-id.xml"})
@ActiveProfiles("http")
public class TestHttpModeWithId {
    ...
    public void testSinkPassthrough() throws Exception {
        ...
        Mockito.verify(restTemplate).exchange(
                new URI("http://localhost:9200/twitter/tweet/1"),
                HttpMethod.PUT,
